...
type CommodityInfo struct {
	ID             int64    `gorm:"type:bigint;primary_key;comment:商品id" json:"id"`
	...
	Type           *int64   `gorm:"type:bigint;not null;default:0;comment:商品类型" json:"type" binding:"required"`
	...
	Supplier       *int64   `gorm:"type:bigint;not null;default:0;comment:商品供应商" json:"supplier" binding:"required"`
